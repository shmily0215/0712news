...
block_get('54,53,52');?><?php include template('common/header'); ?><div id="pt" class="bm cl">
...
<style id="diy_style" type="text/css">#frameBd053Y {  border:0px !important;margin:0px !important;}#portal_block_52 {  border:0px !important;margin:0px !important;}#portal_block_52 .dxb_bc {  margin:0px !important;}#frameUtesEa {  border:0px !important;margin:0px !important;}#portal_block_53 {  border:0px !important;margin:0px !important;}#portal_block_53 .dxb_bc {  margin:0px !important;}#framep2ifcP {  border:0px !important;margin:0px !important;}#portal_block_54 {  border:0px !important;margin:0px !important;}#portal_block_54 .dxb_bc {  margin:0px !important;}</style>

<?php if(empty($gid)) { ?>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="framep2ifcP" class=" frame move-span cl frame-1"><div id="framep2ifcP_left" class="column frame-1-c"><div id="framep2ifcP_left_temp" class="move-span temp"></div><?php block_display('54');?></div></div><div id="frameUtesEa" class=" frame move-span cl frame-1"><div id="frameUtesEa_left" class="column frame-1-c"><div id="frameUtesEa_left_temp" class="move-span temp"></div><?php block_display('53');?></div></div><div id="frameBd053Y" class=" frame move-span cl frame-1"><div id="frameBd053Y_left" class="column frame-1-c"><div id="frameBd053Y_left_temp" class="move-span temp"></div><?php block_display('52');?></div></div></div><!--[/diy]-->
</div>
<?php } ?>
