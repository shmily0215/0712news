...
0
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_setting.htm', 1495852129, '2', './data/template/2_2_portal_portalcp_block.tpl.php', './template/zhikai_n5chengshiv6', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_thumbsetting.htm', 1495852129, '2', './data/template/2_2_portal_portalcp_block.tpl.php', './template/zhikai_n5chengshiv6', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_setting.htm', 1495852129, '2', './data/template/2_2_portal_portalcp_block.tpl.php', './template/zhikai_n5chengshiv6', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_thumbsetting.htm', 1495852129, '2', './data/template/2_2_portal_portalcp_block.tpl.php', './template/zhikai_n5chengshiv6', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_nav.htm', 1495852129, '2', './data/template/2_2_portal_portalcp_block.tpl.php', './template/zhikai_n5chengshiv6', 'portal/portalcp_block')
