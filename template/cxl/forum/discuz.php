...
<div id="ct" class="wp cl{if $_G['setting']['forumallowside']} ct2{/if}">
	...
	<div class="mn">
					...
					<table cellspacing="0" cellpadding="0" class="fl_tb">
						...
						<!--{eval $forumurl = !empty($forum['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$forum['domain'].'.'.$_G['setting']['domain']['root']['forum'] : 'forum.php?mod=forumdisplay&fid='.$forum['fid'];}-->
							<!--{if $forumcolumns>1}-->
								...
								<td class="fl_g"{if $forumcolwidth} width="$forumcolwidth"{/if}>
									...
									<dl{if !empty($forum[extra][iconwidth]) && !empty($forum[icon])} style="margin-left: {$forum[extra][iconwidth]}px;"{/if}>
										<dt><a href="$forumurl"{if $forum[redirect]} target="_blank"{/if}{if $forum[extra][namecolor]} style="color: {$forum[extra][namecolor]};"{/if}>$forum[name]1</a><!--{if $forum[todayposts] && !$forum['redirect']}--><em class="xw0 xi1" title="{lang forum_todayposts}"> ($forum[todayposts])</em><!--{/if}--></dt>
							...
							<!--{else}-->
								...
								<td>
									<h2><a href="$forumurl"{if $forum[redirect]} target="_blank"{/if}{if $forum[extra][namecolor]} style="color: {$forum[extra][namecolor]};"{/if}>$forum[name]2</a><!--{if $forum[todayposts] && !$forum['redirect']}--><em class="xw0 xi1" title="{lang forum_todayposts}"> ($forum[todayposts])</em><!--{/if}--></h2>
		...
		<!--{loop $catlist $key $cat}-->
			...
			<div class="bm bmw {if $cat['forumcolumns']} flg{/if} cl">
				<div class="bm_h cl">
					...
					<!--{if $cat['moderators']}--><span class="y ptn nvbing5_fqbzys">{lang forum_category_modedby}: $cat[moderators]</span><!--{/if}-->
					...
					<table cellspacing="0" cellpadding="0" class="fl_tb">
						...
						<!--{if $cat['forumcolumns']}-->
							...
							<td class="fl_g" width="$cat[forumcolwidth]">
								...
								<dl{if !empty($forum[extra][iconwidth]) && !empty($forum[icon])} style="margin-left: {$forum[extra][iconwidth]}px; padding-right:20px;"{/if}>
									<dt><a href="$forumurl"{if $forum[redirect]} target="_blank"{/if}{if $forum[extra][namecolor]} style="color: {$forum[extra][namecolor]};"{/if}>$forum[name]</a><!--{if $forum[todayposts] && !$forum['redirect']}--><em class="xw0 xi1 nvbing5_xtyskz" title="{lang forum_todayposts}"> (24时新帖：$forum[todayposts])</em><!--{/if}--></dt>
									<!--{if empty($forum[redirect])}--><dd><em>{lang forum_threads}: <!--{echo dnumber($forum[threads])}--></em>, <em>{lang forum_posts}: <!--{echo dnumber($forum[posts])}--></em></dd><!--{/if}-->
									<div class="nvbing5_jsdw">
		...
		<!--{if empty($gid) && $_G['setting']['whosonlinestatus']}-->
			<div id="online" class="bm oll nvbing5_zxhybk">
				<div class="bm_h nvbing5_zxhybk">
				<!--{if $detailstatus}-->
		...
		<div class="bm lk nvbing5_yqljbk">
	...
	<!--{if $_G['setting']['forumallowside']}-->
		<div id="sd" class="sd">
		    ...
		    <div class="nvbing5_bbsbl nvbing5_hdgd">
			    <div class="nvbing5_blnbl">				
			        <div id="left_focus"><!--幻灯片-->	
                        <div class="sub_box">
                            <div id="p-select" class="sub_nav_bbs">
                            ...
                            <!--[diy=nvbing5_blhd]--><div id="nvbing5_blhd" class="area"></div><!--[/diy]-->
                        </div>
			...
			<div class="nvbing5_bbsbl">			
                <div class="nvbing5_twrdbt">
				    <h2>图文热点</h2>
			    </div>
			    <ul class="n5_hdlb">
                    <!--[diy=nvbing5_lbtw]--><div id="nvbing5_lbtw" class="area"></div><!--[/diy]-->
			    </ul>
			</div>
			
			<div class="nvbing5_bbsbl nvbing5_hdgd1">
			    <div class="nvbing5_blnbj">	
				    <div class="nvbing5_hyph">
				        <h2>一周热门</h2>
			        </div>
				    <ul class="n5_shxdlb">
                        <!--[diy=n5_shxdlb]--><div id="n5_shxdlb" class="area"></div><!--[/diy]-->
					</ul>
			    </div>
			</div>
