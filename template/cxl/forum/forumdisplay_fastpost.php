					...
					<div class="tedt">
						<div class="bar">
							<span class="y">
								...
								使用 <a href="forum.php?mod=post&action=newthread&fid=$_G[fid]" onclick="switchAdvanceMode(this.href);doane(event);" style="color:#FF6600;"><b>{lang post_advancemode}</b></a>（可批量传图、插入视频等）
							</span>
