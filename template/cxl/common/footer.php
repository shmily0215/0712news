	...
	<div class="footer">
        ...
        <div class="footer-link clearall">
            <p><!--{loop $_G['setting']['footernavs'] $nav}--><!--{if $nav['available'] && ($nav['type'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1)) ||
						!$nav['type'] && ($nav['id'] == 'stat' && $_G['group']['allowstatdata'] || $nav['id'] == 'report' && $_G['uid'] || $nav['id'] == 'archiver' || $nav['id'] == 'mobile' || $nav['id'] == 'darkroom'))}-->$nav[code]<span class="pipe">|</span><!--{/if}--><!--{/loop}--><!--{if $_G['setting']['site_qq']}--><a href="http://wpa.qq.com/msgrd?V=3&Uin=$_G['setting']['site_qq']&Site=$_G['setting']['bbname']&Menu=yes&from=discuz" target="_blank" title="与客服对话">客服在线</a><!--{/if}--></p>
        </div>
        <p>Copyright &copy; 2011-2014 <a href="$_G['setting']['siteurl']" target="_blank">$_G['setting']['sitename']</a> ($_G['setting']['siteurl']) 版权所有 All Rights Reserved.</p>
        <p>Powered by <a href="http://www.adminbuy.cn/" target="_blank">Discuz!</a> $_G['setting']['version']  技术支持: <a href="http://www.adminbuy.cn/" target="_blank">www.adminbuy.cn</a> <a href="http://www.adminbuy.cn/" target="_blank">$_G['setting']['icp']</a> <!--{if $_G['setting']['statcode']}-->$_G['setting']['statcode']<!--{/if}--></p>
		<p class="n5_wbtp">
